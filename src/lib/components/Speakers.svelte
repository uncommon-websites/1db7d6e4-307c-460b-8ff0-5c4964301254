<script lang="ts">
  ...
  const featuredSpeakers = [
    { name: 'Sarah Mitchell', role: 'Managing Partner', company: 'McKinsey & Company', img: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=300&q=80' },
    { name: 'Marcus Weber', role: 'CEO', company: 'Deutsche Bank', img: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=300&q=80' },
    { name: 'Elena Petrova', role: 'Partner', company: 'Bain & Company', img: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=300&q=80' },
    { name: 'Thomas Schmidt', role: 'Managing Director', company: 'Goldman Sachs', img: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=300&q=80' }
  ];

  const moreSpeakers = [
    { name: 'Anna Hoffmann', role: 'Senior Partner', company: 'BCG' },
    { name: 'David Chen', role: 'Vice President', company: 'Morgan Stanley' },
    { name: 'Laura Rossi', role: 'Managing Director', company: 'Bank of America' },
    { name: 'Michael Bauer', role: 'Partner', company: 'PwC Strategy&' },
    { name: 'Sophie Laurent', role: 'Chief Innovation Officer', company: 'Allianz Global Investors' },
    { name: 'Robert Fischer', role: 'Head of Corporate Development', company: 'PepsiCo Europe' },
    { name: 'Julia Meier', role: 'Managing Director', company: 'BNP Paribas' },
    { name: 'Alexander Koch', role: 'Partner', company: 'EY-Parthenon' }
  ];
</script>

<section class="py-20 px-6 max-w-[1400px] mx-auto border-t border-gray-200 overflow-hidden" id="speakers">
      ...
      {#each featuredSpeakers as speaker}
        <div class="w-[280px] md:w-[320px] bg-white rounded-lg overflow-hidden shadow-sm group cursor-pointer relative flex flex-col h-[420px] border border-gray-100 transition-all hover:shadow-md">
            ...
            <div class="p-6 bg-white border-t border-gray-100 relative">
                <p class="text-xs font-bold text-[#110F28] mb-1">{speaker.company}</p>
